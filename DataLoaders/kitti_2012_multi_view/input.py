...
class KITTI_2012_MultiView_Dataset(Dataset):
    ...
    def __init__(self, datadir=None, crop_size=None, min_scale=1.0, max_scale=1.0,
        ...
        super(KITTI_2012_MultiView_Dataset, self).__init__()
...
dataset = KITTI_2012_MultiView_Dataset(datadir=datadir, num_frames=5, crop_size=(320, 1152),
